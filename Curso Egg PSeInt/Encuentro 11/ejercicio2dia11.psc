...
Algoritmo sin_titulo
	definir user, pass, user_in, pass_in, Albus_D, caramelosDeLimon Como Caracter
	Definir cont, opciones, cantB, pesoB Como Entero
	...
	Repetir
		...
		si ((!user=!user_in) o (!pass=!pass_in)) Entonces
			...
			cont=cont+1
		FinSi
	Hasta Que cont=3 o ((user=user_in) y (pass=pass_in))
	
	si cont=3 Entonces
		Limpiar Pantalla
		Escribir "AGOTO LOS 3 INTENTOS DISPOBIBLES, USUARIO BLOQUEADO"
	FinSi
